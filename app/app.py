...
def purchase():
    customers = Customer.query.all()
    items = Item.query.all()
    return render_template("purchase/index.html",customers=customers,items=items)
...
def purchase_data_statistics():
    ...
    customers = Customer.query.all()
    return render_template("data/index.html",joined_purchase_details=joined_purchase_details,customers=customers)
...
def add_customer():
    ...
    return render_template("customer/added.html",customer=customer)
...
def select_gender():
    ...
    return render_template("customer/selected.html",customers=customers)
...
def add_item():
    ...
    try:
        ...
        return render_template("error.html")
    return render_template("item/added.html",item=item)
...
def update_item():
    ...
    try:
        ...
        return render_template("error.html")
    return render_template("item/updated.html",item=item)
...
def select_item_name():
    ...
    result_type = "抽出"
    return render_template("item/result.html",items=items,result_type=result_type)
...
def add_purchase():
    ...
    return render_template("purchase/purchased.html",purchase=purchase)
...
def delete_purchase():
    ...
    try:
        ...
        return render_template("error.html")
    return render_template("purchase/deleted.html",purchase=purchase)
...
def search_purchase():
    ...
    if is_customer_or_date and item_name:
        ...
        return render_template("data/result_search.html",purchase_details=purchase_details)
...
def ranking_items():
    ...
    return render_template("data/result_ranking.html",statistics_type=statistics_type,items=items)
